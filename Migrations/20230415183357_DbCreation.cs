        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroVuelo = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    HorarioLLegada = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LineaAerea = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
